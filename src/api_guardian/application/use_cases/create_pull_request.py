...
class CreatePullRequestUseCase:
    ...
    def execute(self, ctx: TenantContext, case_id: uuid.UUID, patch_artifact: Any) -> tuple[int, str]:
        ...
        files_to_update = {block.file_path: block.modified_snippet for block in patch_artifact.diff_blocks}
